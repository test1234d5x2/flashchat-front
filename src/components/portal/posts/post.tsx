...
export default function Post() {
    return (
        <section className="w-full border-b border-gray-200 cursor-pointer">
            <Link href={`/portal/post/sajgdvashgd`}>
                <div className="flex items-start gap-4 hover:bg-white p-4">
